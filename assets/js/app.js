...
document.querySelectorAll('[data-menu-toggle]').forEach((toggle) => {
  const menu = document.querySelector(toggle.dataset.menuTarget || '[data-menu]');
  if (!menu) return;
  toggle.addEventListener('click', () => {
...
const unavailablePaymentModal = document.querySelector('[data-payment-unavailable-modal]');
const checkoutForm = document.querySelector('[data-checkout-form]');
const cashOnDelivery = document.querySelector('input[name="payment_method"][value="cod"]');
